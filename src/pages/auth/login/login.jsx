...
import "./login.css"
import { Button, Navbar, ListGroup, Dropdown, Carousel, Form, Toast } from "react-bootstrap";
                    ...
                    <div className="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
                        <Form>
                            ...
                            <div className="text-center text-lg-start mt-4 pt-2">
                                <Button onClick={() => checkFirstHandError()} type="button" className="btn btn-primary btn-lg"
                                    style={{
                                        paddingLeft: "2.5rem",
                                        paddingRight: "2.5rem",
                                    }} id="btnS">Login</Button>
                                <p className="small fw-bold mt-2 pt-1 mb-0 textL">Don't have an account? <Link to="/register" style={{ textDecoration: 'none' }} className="iText">Register</Link></p>
                            </div>
