...
import { Button, Navbar, ListGroup, Dropdown, Carousel, Card, Col, Row } from "react-bootstrap";
...
function ShowCategory() {
  ...
  const linkI = ['https://drive.google.com/uc?export=view&id=19hEWuwRILVFcDOBF9sq5yTnrjS8sydN5',
    ...
    <div id="all">
      ...
      <Row xs={1} md={2} className="g-4">
        {textData.map((titleT, index) =>
          <Col>
            <Card>
              <Card.Img variant="top" src={linkI[index]} style={{maxHeight: "50vh", maxWidth: "100%"}}/>
              <Card.Body>
